...
Create a system where any teammate can find the latest launch/campaign truth in <60 seconds: the **current brief**, **latest assets**, **latest metrics**, and **current decisions** — without asking Gargoyle.
