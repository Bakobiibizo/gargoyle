...
Establish a lightweight system to capture: **what was decided**, **why**, **who owns the follow-through**, and **when it will be reviewed**. This removes Gargoyle as the memory database.
...
- Gargoyle is becoming the bottleneck for alignment.
